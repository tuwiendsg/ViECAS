...
public class FlatConnectednessMembershipFunctions implements MembershipFunctions {

  private static FlatConnectednessMembershipFunctions functions;
  ...
  public static FlatConnectednessMembershipFunctions getInstance() {
    if (functions==null) functions = new FlatConnectednessMembershipFunctions();
    return functions;
  }
