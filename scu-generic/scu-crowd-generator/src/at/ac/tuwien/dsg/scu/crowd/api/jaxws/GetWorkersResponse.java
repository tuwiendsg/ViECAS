...
@XmlRootElement(name = "getWorkersResponse", namespace = "http://api.crowd.scu.dsg.tuwien.ac.at/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getWorkersResponse", namespace = "http://api.crowd.scu.dsg.tuwien.ac.at/")
