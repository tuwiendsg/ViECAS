...
@XmlRootElement(name = "assignJobBatch", namespace = "http://api.crowd.scu.dsg.tuwien.ac.at/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "assignJobBatch", namespace = "http://api.crowd.scu.dsg.tuwien.ac.at/")
